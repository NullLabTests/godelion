...
class AgenticSystem:
    def __init__(
        self, problem_statement, git_tempdir, base_commit, chat_history_file="./chat_history.md", test_description=None, self_improve=False, language="python"
    ):
...
def main():
    ...
    parser.add_argument(
        "--language", required=False, default="python", choices=["cpp", "java", "python", "go", "rust", "javascript"], help="Task's programming language"
    )

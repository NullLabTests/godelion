...
def main():
    ...
    parser.add_argument(
        "--path_no_selfimprove", type=str, default="/home/ubuntu/jz/dgm/output_dgm/20250407212512_767109", help="Path to the baseline (no_selfimprove) run."
    )
    parser.add_argument(
        "--path_no_darwin", type=str, default="/home/ubuntu/jz/dgm/output_dgm/20250416053414_894280", help="Path to the baseline (no_darwin) run."
    )
